  <?php 
   if(isset($_GET['id'],$_GET['page']))
    ...
    $writer=trim($result['author']);
    if(isset($_POST['submit']))
    { 
      $book=$_POST['book'];
      $writer=$_POST['writer'];
      $dept=$_POST['dept'];
      $query=$pdo->query("update book set book_name='$book',author='$writer',department='$dept' where book_id='$id'");
      if($query)
      {
...
<body>
  ...
  <div class="form-group">
    <label for="exampleInputPassword1"><b>Writer:</b></label>
    <input type="text" class="form-control" name="writer" value="<?php echo $writer;?>" required>
  </div>
   <div class="form-group">
